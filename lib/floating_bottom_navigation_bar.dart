...
class FloatingBottomNavigationBar extends StatelessWidget {
  ...
  /// The color of the selected button icon
  final Color? selectedItemIconColor;

  /// The color of the unselected button background
                ...
                for (final item in items)
                  TweenAnimationBuilder<double>(
                    ...
                    builder: (context, t, _) {
                      ...
                      final _borderColor = borderColor ?? Colors.transparent;
                      final _textColor = textColor ?? Colors.black;
                      final _selectedItemIconColor = selectedItemIconColor ?? _unselectedColor;
                      final _unselectedItemBackgroundColor = unselectedItemBackgroundColor ?? Colors.transparent;

                      return Material(
                        color: items.indexOf(item) == currentIndex ? Color.lerp(
                            _selectedColor.withOpacity(0.0),
                            _selectedColor,
                            t) : Color.lerp(
                            _unselectedItemBackgroundColor,
                            _selectedColor.withOpacity(0.0),
                            t),
                        shape:  items.indexOf(item) == currentIndex ? RoundedRectangleBorder(
                          side: BorderSide(color: _borderColor, width: 3.6),
                          borderRadius: BorderRadius.circular(30),
                        ) : CircleBorder(side: BorderSide(color: _borderColor, width: 3.6)),
                        child: InkWell(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                IconTheme(
                                  data: IconThemeData(
                                    color: items.indexOf(item) == currentIndex ? Color.lerp(_unselectedColor?.withOpacity(0.0), _selectedItemIconColor, t) : Color.lerp(_unselectedColor, _selectedColor, t),
                                    size: 24,
                                  ),
                                    ...
                                    child: Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: DefaultTextStyle(
                                          style: TextStyle(
                                            color: Color.lerp(_selectedColor.withOpacity(0.0), _textColor, t),
